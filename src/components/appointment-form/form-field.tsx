  ...
  return (
    <div className="w-full">
      ...
      <div className="relative mt-1">
        ...
        <input
          {...rest}
          className="border-border-primary placeholder:text-content-secondary hover:border-border-secondary
            focus:border-border-brand text-content-primary h-12 w-full rounded-lg border px-4 pl-12 outline-0
