...
export default function Button({ title, variant, ...rest }: ButtonProps) {
  function setVariant() {
    ...
    if (variant === "brand")
      return "bg-background-brand hover:bg-background-highlights active:bg-background-highlights text-content-button text-label-large h-12 w-fit cursor-pointer rounded-[8px] px-6 py-3 uppercase transition-colors duration-200 ease-in-out";
    if (variant === "submitForm")
      return "bg-background-brand hover:bg-background-highlights active:bg-background-highlights text-content-button text-label-large h-12 w-full cursor-pointer rounded-[8px] px-6 py-3 uppercase transition-colors duration-200 ease-in-out";
